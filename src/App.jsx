...
const DEFAULT_VERANSTALTUNGEN = [
  { id: "yoga-julia",          title: "Yoga mit Julia W.",                title_locked: false, description: "", contactName: "", contactPhone: "", contactEmail: "", imageKey: "Yoga_mit_julia.jpeg", imagePosition: "50% 25%", iconPattern: "yoga",   openingHours: DEFAULT_OPENING_HOURS, publicPrice: "", publicPriceLabel: "Eintritt", kaertnerCardFree: false, adminPrice: "", adminPaymentStatus: "open", adminPartialAmount: "", dates: [] },
  { id: "iris-pfingstrosen",   title: "Irisblüten- & Pfingstrosenschau",  title_locked: false, description: "", contactName: "", contactPhone: "", contactEmail: "", imageKey: "iris_cover.jpg",      imagePosition: "50% 50%", iconPattern: "flower", openingHours: DEFAULT_OPENING_HOURS, publicPrice: "", publicPriceLabel: "Eintritt", kaertnerCardFree: false, adminPrice: "", adminPaymentStatus: "open", adminPartialAmount: "", dates: [] },
  { id: "taglilien-sommer",    title: "Taglilien- & Sommerprachtstauden", title_locked: false, description: "", contactName: "", contactPhone: "", contactEmail: "", imageKey: "taglilie_cover.jpg",  imagePosition: "50% 50%", iconPattern: "flower", openingHours: DEFAULT_OPENING_HOURS, publicPrice: "", publicPriceLabel: "Eintritt", kaertnerCardFree: false, adminPrice: "", adminPaymentStatus: "open", adminPartialAmount: "", dates: [] },
  { id: "herbstbluetenzauber", title: "Herbstblütenzauber",               title_locked: false, description: "", contactName: "", contactPhone: "", contactEmail: "", imageKey: "herbst_cover.png",    imagePosition: "50% 50%", iconPattern: "leaf",   openingHours: DEFAULT_OPENING_HOURS, publicPrice: "", publicPriceLabel: "Eintritt", kaertnerCardFree: false, adminPrice: "", adminPaymentStatus: "open", adminPartialAmount: "", dates: [] },
  { id: "lebenskunst",         title: 'Workshop "Lebenskunst"',           title_locked: false, description: "", contactName: "", contactPhone: "", contactEmail: "", imageKey: "",                    imagePosition: "50% 50%", iconPattern: "sound",  openingHours: DEFAULT_OPENING_HOURS, publicPrice: "", publicPriceLabel: "Eintritt", kaertnerCardFree: false, adminPrice: "", adminPaymentStatus: "open", adminPartialAmount: "", dates: [] },
];
...
export default function App() {
  ...
  useEffect(() => {
    if (modalView || editingType || publicEventDetail) {
  ...
  }, [modalView, editingType, loginModal, publicEventDetail]);
  ...
  // "Speichern"-Button (handleAdminSave). Kein automatisches Speichern im Hintergrund mehr.
    ...
    <div style={{ minHeight:"100svh", ...(isAdmin ? {} : { display:"flex", flexDirection:"column" }), background: isAdmin ? adminTheme.bgColor : siteTheme.bgColor, fontFamily:"'Acumin Pro', 'Segoe UI', system-ui, sans-serif", overflowX:"hidden", WebkitTextSizeAdjust:"100%" }}>
      ...
      <header style={{ background: isAdmin ? BRAND.aubergine : siteTheme.headerBg, color: isAdmin ? "#fff" : siteTheme.headerText, padding: winW < 520 ? "6px 12px" : "8px 24px", display:"flex", alignItems:"center", justifyContent:"space-between", position: winW < 1100 ? "sticky" : "relative", top:0, zIndex:50 }}>
        <div onClick={!isAdmin ? () => { if (loggedIn) { setIsAdmin(true); setModalView(null); } else setLoginModal(true); } : undefined}
          ...
          {winW < 520 ? (
            <>
              <img src={isAdmin ? "/assets/logo-titelbild.png" : "/assets/PGM_Logo_Weiss_RGB_3.svg"} alt="Paradiesgärten Mattuschka"
      ...
      <div style={{ maxWidth: !isAdmin ? "100%" : winW > 900 ? 1100 : 700, margin:"0 auto", padding: !isAdmin ? 0 : winW < 520 ? "12px 10px" : winW > 900 ? "24px 40px" : "16px 16px", ...(!isAdmin ? { flex:"1 1 auto", display:"flex", flexDirection:"column", width:"100%", boxSizing:"border-box" } : {}) }}>
        ...
        {showVeranstaltungenAdmin && (() => {
          ...
          const startNew = () => {
            ...
            setVeranstaltungDraft({ id:"", title:"", description:"", contactName:"", contactPhone:"", contactEmail:"", imageKey:"", imagePosition:"50% 50%", iconPattern:"yoga", openingHours: DEFAULT_OPENING_HOURS, publicPrice:"", kaertnerCardFree:false, adminPrice:"", adminPaymentStatus:"open", adminPartialAmount:"", dates:[] });
          };
                ...
                {!draft ? (
                  ...
                  <>
                    ...
                    <div style={{ background:`${BRAND.tuerkis}08`, borderRadius:12, padding:"14px 16px", marginBottom:12, border:`1px solid ${BRAND.tuerkis}20`, borderLeft:`3px solid ${BRAND.tuerkis}` }}>
                      ...
                      <div style={{ fontSize:11, color:"#999", marginBottom:10 }}>Name, Telefon und E-Mail der Kontaktperson für diese Veranstaltung</div>
                      ...
                      <input placeholder="Telefon" value={draft.contactPhone || ""} onChange={e => patchDraft({ contactPhone: e.target.value })}
                        style={{ width:"100%", padding:"10px 12px", border:"1px solid #e8d8e4", borderRadius:8, fontSize:14, fontFamily:"inherit", boxSizing:"border-box", marginBottom:6, color:BRAND.aubergine }} />
                      <input placeholder="E-Mail (optional)" type="email" value={draft.contactEmail || ""} onChange={e => patchDraft({ contactEmail: e.target.value.trim() })}
                            ...
                            <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:4, gap:8 }}>
                              ...
                              {subIsPending && (
                                <button onClick={(e) => { e.stopPropagation(); editSub(); }}
                                  ...
                                  style={{ background:"#fff", border:`1px solid ${BRAND.aprikot}40`, borderRadius:5, padding:"4px 6px", cursor:"pointer", display:"flex", alignItems:"center", transition:"all .15s", flexShrink:0 }}>
